...
# Open the Brotli-encoded file in binary mode
with open(r'C:\Users\demo\Desktop\oceanActivistPortal\static\game\Build\game.data.br', 'rb') as file_in:
    # Read the Brotli-encoded data from the file
    compressed_data = file_in.read()
...
# Open a new file for writing the decompressed data
with open(r'C:\Users\demo\Desktop\oceanActivistPortal\static\game\Build\game.data', 'wb') as file_out:
    # Write the decompressed data to the new file
    file_out.write(decompressed_data)
...
# Open the Brotli-encoded file in binary mode
with open(r'C:\Users\demo\Desktop\oceanActivistPortal\static\game\Build\game.wasm.br', 'rb') as file_in:
    # Read the Brotli-encoded data from the file
    compressed_data = file_in.read()
...
# Open a new file for writing the decompressed data
with open(r'C:\Users\demo\Desktop\oceanActivistPortal\static\game\Build\game.wasm', 'wb') as file_out:
    # Write the decompressed data to the new file
    file_out.write(decompressed_data)
